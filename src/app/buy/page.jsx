        ...
        <main className="flex pt-[80px] max-lg:flex-col h-fit">
            ...
            <div className="flex-[0.5] p-10 bg-gray-200">
                <div className="w-[70%] max-lg:w-full h-fit flex bg-white p-5 sticky top-24 rounded-lg shadow-xl flex-col gap-5 ">
                    {cart.length > 0 ? (
                        cart.map((item) => (
                            <div key={item._id} className="flex justify-between w-full px-3 h-fit">
                                <div className="flex gap-2 items-center  w-full h-fit">
                                    <img src={item.imageUrl} className="h-[70px] w-[70px] border-gray-500 border-1 shadow-lg rounded-lg" />
                                    <h1 className="font-serif">{item.name}</h1>
                                </div>
                                <div className="flex items-center flex-nowrap">E£ <p className="flex ">{item.price} </p> <span>x{item.quantity}</span></div>
                            </div>
                        ))
                    ) : null}
                    ...
                    <div className="flex justify-between px-3 w-full h-fit">
                        <p>Subtotal</p>
                        <div className="flex items-center flex-nowrap">E£ <p>{total()}.00
                        </p></div>
                    </div>
                    <div className="flex justify-between px-3 w-full h-fit">
                        <p>Shipping Fees</p>
